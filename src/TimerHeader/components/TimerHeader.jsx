...
<div id="2" className="center  white  ">
     ...
     <div className="f4-l f5-m ">The pomodoro technique is a worldwide known proven optimal method of studying developed by Francesco Cirillo in the late 1980s.</div>
     <ul>
...
<footer id="3" className="pv4 ph3 tc bordz">
  ...
  <h3>You can find us on  Facebook for the latest updates about the website application</h3>
